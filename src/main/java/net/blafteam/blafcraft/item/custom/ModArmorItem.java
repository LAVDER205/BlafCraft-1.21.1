...
import net.blafteam.blafcraft.item.ModArmorMaterials;
    ...
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.BISMUTH_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 2, 1, false, false),
                            new MobEffectInstance(MobEffects.GLOWING, 2, 1, false, false)))
//                    .put(ModArmorMaterials.CREATION_ARMOR_MATERIAL,
//                            List.of(new MobEffectInstance(MobEffects.HEALTH_BOOST, 200, 4, false, false),
//                                    new MobEffectInstance(MobEffects.HERO_OF_THE_VILLAGE, 2, 0, false, false),
//                                    new MobEffectInstance(MobEffects.GLOWING, 2, 0, false, false)))
                    .build();
