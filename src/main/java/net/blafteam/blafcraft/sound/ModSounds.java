...
public class ModSounds {
    public  static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(BuiltInRegistries.SOUND_EVENT, BlafCraft.MODID);
    ...
    public static final  Supplier<SoundEvent> OVERDOSE = registerSoundEvent("overdose");
    ...
    private static Supplier<SoundEvent> registerSoundEvent(String name) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(BlafCraft.MODID, name);
