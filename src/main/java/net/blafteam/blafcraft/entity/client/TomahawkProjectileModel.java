package net.blafteam.blafcraft.entity.client;
...
public class TomahawkProjectileModel extends EntityModel<TomahawkProjectileEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BlafCraft.MODID, "tomahawk"), "main");
    private final ModelPart tomahawk;

    public TomahawkProjectileModel(ModelPart root) { // constructor
